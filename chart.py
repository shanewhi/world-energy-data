...
# 1x3 column subplots.
#
# Returns: Single figure 1x3 column subplots with optional equivalent y-axis
# scales.
#
###############################################################################
def column_1x3(
    ...
    if max(series1) == 0:
        ...
        ax[0].bar(series1.index, series1, width = 1,
...
def column_1x4(
    ...
    # If nil data remove y-axis detail, else plot bar chart.
    if max(series4) == 0:
        ax[3].plot(series3.index, series4, color4, linewidth =
                   user_globals.Constant.LINE_WIDTH_SUBPOLT.value)
    else:
        ax[3].bar(series4.index, series4, width = 1, color = color4,
...
def column_2x3(
        ...
        ylabel, footer_text, equiv_yscale):
...
def column_2x4(
        ...
        series5, series6, series7, series8, # 8 series to plot.
        color1, color2, color3, color4, color5, color6,color7, color8,
        country_name, title,
        subplot1_title, subplot2_title, subplot3_title, subplot4_title,
        subplot5_title, subplot6_title, subplot7_title, subplot8_title,
        ylabel, footer_text, equiv_yscale):
    ...
    if  max(series4) == 0:
        ax[0, 3].plot(series4.index, series4, color4, linewidth =
                   user_globals.Constant.LINE_WIDTH_SUBPOLT.value)
    else:
        ax[0, 3].bar(series4.index, series4, width = 1, color = color4,
                     edgecolor = edge_color4, linewidth = 0.2)
    ...
    if  max(series5) == 0:
        ax[1, 0].plot(series5.index, series5, color5, linewidth =
                   user_globals.Constant.LINE_WIDTH_SUBPOLT.value)
    else:
        ax[1, 0].bar(series5.index, series5, width = 1, color = color5,
                     edgecolor = edge_color5, linewidth = 0.2)
    ax[1, 0].set_axisbelow(True)
    ax[1, 0].set_title(
        subplot5_title,
    ...
    if  max(series6) == 0:
        ax[1, 1].plot(series6.index, series6, color6, linewidth =
                   user_globals.Constant.LINE_WIDTH_SUBPOLT.value)
    else:
        ax[1, 1].bar(series6.index, series6, width = 1, color = color6,
                     edgecolor = edge_color6, linewidth = 0.2)
    ax[1, 1].set_axisbelow(True)
    ax[1, 1].set_title(
        subplot6_title,
    ...
    if  max(series7) == 0:
        ax[1, 2].plot(series7.index, series7, color7, linewidth =
                   user_globals.Constant.LINE_WIDTH_SUBPOLT.value)
    else:
        ax[1, 2].bar(series7.index, series7, width = 1, color = color7,
                     edgecolor = edge_color7, linewidth = 0.2)
    ax[1, 2].set_axisbelow(True)
    ax[1, 2].set_title(
        subplot7_title,
        loc = "left",
    ...
    if  max(series8) == 0:
        ax[1, 3].plot(series8.index, series8, color8, linewidth =
                   user_globals.Constant.LINE_WIDTH_SUBPOLT.value)
    else:
        ax[1, 3].bar(series8.index, series8, width = 1, color = color8,
                     edgecolor = edge_color8, linewidth = 0.2)
...
def line_1x4(
    ...
    ax[0].yaxis.grid(True)
    ax[0].set_xlim(min(series1.index), max(series1.index))
    ...
    ax[1].set_xlabel("Year")
    ax[1].yaxis.grid(True)
    ax[1].set_xlim(min(series2.index), max(series2.index))
    ...
    ax[2].set_xlabel("Year")
    ax[2].yaxis.grid(True)
    ax[2].set_xlim(min(series3.index), max(series3.index))
    ax[2].set_xticks(x_ticks)
    ax[2].set_box_aspect(1)
    ax[2].autoscale(axis = "y")
    ylim3 = ax[2].get_ylim()[1]

    ax[3].plot(series4.index, series4, color4, linewidth = \
                  user_globals.Constant.LINE_WIDTH_SUBPOLT.value)
    ax[3].set_title(
            subplot4_title,
            loc = "left",
    ...
    ax[3].set_xlabel("Year")
    ax[3].yaxis.grid(True)
    ax[3].set_xlim(min(series4.index), max(series4.index))
...
def line_2x4(
    ...
    ax[0, 3].set_xlim(min(series4.index), max(series4.index))
    ax[0, 3].set_xticks(x_ticks)
    ax[0, 3].set_box_aspect(1)
    ax[0, 3].autoscale(axis = "y")
    ylim4 = ax[0, 3].get_ylim()[1]
    ...
    ax[1, 0].set_ylabel(ylabel)
    ax[1, 0].set_xlabel("Year")
    ax[1, 0].set_xlim(min(series5.index), max(series5.index))
    ax[1, 0].set_xticks(x_ticks)
    ax[1, 0].set_box_aspect(1)
    ax[1, 0].autoscale(axis = "y")
    ylim5 = ax[1, 0].get_ylim()[1]
    ...
    ax[1, 1].set_title(
            ...
            weight = user_globals.Constant.TITLE_FONT_WEIGHT.value)
    ax[1, 1].set_xlabel("Year")
    ax[1, 1].set_xlim(min(series6.index), max(series6.index))
    ax[1, 1].set_xticks(x_ticks)
    ax[1, 1].set_box_aspect(1)
    ax[1, 1].autoscale(axis = "y")
    ylim6 = ax[1, 1].get_ylim()[1]
    ...
    ax[1, 2].set_title(
            ...
            weight = user_globals.Constant.TITLE_FONT_WEIGHT.value)
    ax[1, 2].set_xlabel("Year")
    ax[1, 2].set_xlim(min(series7.index), max(series7.index))
    ax[1, 2].set_xticks(x_ticks)
    ax[1, 2].set_box_aspect(1)
    ax[1, 2].autoscale(axis = "y")
    ylim7 = ax[1, 2].get_ylim()[1]
    ...
    ax[1, 3].set_title(
            ...
            weight = user_globals.Constant.TITLE_FONT_WEIGHT.value)
    ax[1, 3].set_xlabel("Year")
    ax[1, 3].set_xlim(min(series8.index), max(series8.index))
    ax[1, 3].set_xticks(x_ticks)
    ax[1, 3].set_box_aspect(1)
    ax[1, 3].autoscale(axis = "y")
    ylim8 = ax[1, 3].get_ylim()[1]
...
def column_grouped(
    ...
    for key, value in series.items():
        ...
        p = ax.bar(series.truncate(before = start_yr).index.astype \
               ...
               start_yr), width = column_width*0.9,
