...
https://github.com/shanewhi/world-energy-data."
    ...
    if user_globals.Constant.DISPLAY_CHARTS.value is True:
        plt.show()
    plt.savefig(
        os.path.join(fig_dir, "2 prod ff shares.svg"),
        format="svg",
        bbox_inches="tight",
        pad_inches=0.2,
    )
...
https://github.com/shanewhi/world-energy-data."
    ...
    if user_globals.Constant.DISPLAY_CHARTS.value is True:
        plt.show()
    plt.savefig(
        os.path.join(fig_dir, "3 prod ff sep.svg"),
        format="svg",
        bbox_inches="tight",
        pad_inches=0.2,
    )
...
https://github.com/shanewhi/world-energy-data."
    ...
    if user_globals.Constant.DISPLAY_CHARTS.value is True:
        plt.show()
    plt.savefig(
        os.path.join(fig_dir, "4 pe shares.svg"),
        format="svg",
        bbox_inches="tight",
        pad_inches=0.2,
    )
...
https://github.com/shanewhi/world-energy-data."
    ...
    if user_globals.Constant.DISPLAY_CHARTS.value is True:
        plt.show()
    plt.savefig(
        os.path.join(fig_dir, "5 pe share trends.svg"),
        format="svg",
        bbox_inches="tight",
        pad_inches=0.2,
    )
...
https://github.com/shanewhi/world-energy-data."
    ...
    if user_globals.Constant.DISPLAY_CHARTS.value is True:
        plt.show()
    plt.savefig(
        os.path.join(fig_dir, "6 pe ff qty.svg"),
        format="svg",
        bbox_inches="tight",
        pad_inches=0.2,
    )
...
https://github.com/shanewhi/world-energy-data."
    ...
    if user_globals.Constant.DISPLAY_CHARTS.value is True:
        plt.show()
    plt.savefig(
        os.path.join(fig_dir, "7 pe ff change.svg"),
        format="svg",
        bbox_inches="tight",
        pad_inches=0.2,
    )
...
https://github.com/shanewhi/world-energy-data."
    ...
    if user_globals.Constant.DISPLAY_CHARTS.value is True:
        plt.show()
    plt.savefig(
        os.path.join(fig_dir, "8 pe sep ff change.svg"),
        format="svg",
        bbox_inches="tight",
        pad_inches=0.2,
    )
...
https://github.com/shanewhi/world-energy-data."
    ...
    if user_globals.Constant.DISPLAY_CHARTS.value is True:
        plt.show()
    plt.savefig(
        os.path.join(fig_dir, "9 fe elec shares.svg"),
        format="svg",
        bbox_inches="tight",
        pad_inches=0.2,
    )
...
Python, https://github.com/shanewhi/world-energy-data."
    ...
    if user_globals.Constant.DISPLAY_CHARTS.value is True:
        plt.show()
    plt.savefig(
        os.path.join(fig_dir, "10 fe share trends.svg"),
        format="svg",
        bbox_inches="tight",
        pad_inches=0.2,
    )
...
https://github.com/shanewhi/world-energy-data."
    ...
    if user_globals.Constant.DISPLAY_CHARTS.value is True:
        plt.show()
    plt.savefig(
        os.path.join(fig_dir, "11 fe qty.svg"),
        format="svg",
        bbox_inches="tight",
        pad_inches=0.2,
    )
...
https://github.com/shanewhi/world-energy-data."
    ...
    if user_globals.Constant.DISPLAY_CHARTS.value is True:
        plt.show()
    plt.savefig(
        os.path.join(fig_dir, "12 fe change.svg"),
        format="svg",
        bbox_inches="tight",
        pad_inches=0.2,
    )
...
https://github.com/shanewhi/world-energy-data."
        ...
        if user_globals.Constant.DISPLAY_CHARTS.value is True:
            plt.show()
        plt.savefig(
            os.path.join(fig_dir, "13 elec cat share trends.svg"),
            format="svg",
            bbox_inches="tight",
            pad_inches=0.2,
        )
...
https://github.com/shanewhi/world-energy-data."
        ...
        if user_globals.Constant.DISPLAY_CHARTS.value is True:
            plt.show()
        plt.savefig(
            os.path.join(fig_dir, "14 elec fuel share trends.svg"),
            format="svg",
            bbox_inches="tight",
            pad_inches=0.2,
        )
...
https://github.com/shanewhi/world-energy-data."
        ...
        plt.savefig(
            os.path.join(fig_dir, "15 elec cat qty.svg"),
            format="svg",
            bbox_inches="tight",
            pad_inches=0.2,
        )
...
https://github.com/shanewhi/world-energy-data."
        ...
        plt.savefig(
            os.path.join(fig_dir, "16 elec fuel qty.svg"),
            format="svg",
            bbox_inches="tight",
            pad_inches=0.2,
        )
...
https://github.com/shanewhi/world-energy-data."
        ...
        if user_globals.Constant.DISPLAY_CHARTS.value is True:
            plt.show()
        plt.savefig(
            os.path.join(fig_dir, "17 elec cat change.svg"),
            format="svg",
            bbox_inches="tight",
            pad_inches=0.2,
        )
...
https://github.com/shanewhi/world-energy-data."
        ...
        if user_globals.Constant.DISPLAY_CHARTS.value is True:
            plt.show()
        plt.savefig(
            os.path.join(fig_dir, "18 elec fuel change.svg"),
            format="svg",
            bbox_inches="tight",
            pad_inches=0.2,
        )
